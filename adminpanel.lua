...
Window:Tag({ Title = "Admin v1.0", Color = Color3.fromRGB(0, 255, 100) })
...
-- Admin (placeholders)
Tabs.Admin:Toggle({ Title = "Fly (toggle)", Value = false, Callback = function(v) end })
Tabs.Admin:Toggle({ Title = "Noclip (toggle)", Value = false, Callback = function(v) end })
Tabs.Admin:Toggle({ Title = "Fling (toggle)", Value = false, Callback = function(v) end })
Tabs.Admin:Toggle({ Title = "Anti Fling", Value = false, Callback = function(v) end })
...
-- Executor (with auto execute on Enter + rejoin)
...
-- Keybinds
Tabs.Keybinds:Keybind({ Title = "Open/Close UI", Key = Enum.KeyCode.RightControl, Callback = function() end })
